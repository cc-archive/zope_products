<master src="master">
<property name="title">Flickr | Creative Commons</property>

<h2>Features</h2>
<div class="smallcat">Featured artists, tools, and works</div>

<span class="feature-inside"><img src="/images/features/150flickr.jpg" width="150" height="150" alt="Dos Pesos, Flickr's mascot" class="imgborder"  /></span> 

<h1>Flickr</h1>
<p class="smalldates" style="font-size:10px;">Interview by <a href="/about/people#14">Matthew Haughey</a><br /> 
July 2004</p>
...
<p><strong>Creative Commons: Can you tell us how flickr came to be?</strong></p>

<p>Stewart Butterfield, Flickr: That's a long and twisted story! In many ways, Flickr is still coming to be. We decided to begin development on a photo sharing
application on December 8th, 2003, and the first preview release
went live on February 10th.</p>

<span class="licensebox" style="float:right;margin:14px;"><strong>featured Flickr work</strong><br /><em><a href="http://www.flickr.com/photos/stefnoble/">Stef Noble's Photos</a></em><br />Attribution<br /> Non-commercial <br />Share Alike 2.0</span>

<p>Since then it has changed a lot, and the emphasis has shifted
...
<p><strong>CC: Flickr has many interesting features surrounding the idea 
of putting photos on the web. Can you talk about what sorts of goals you 
have for Flickr, and where the application might be headed?</strong></p>

<p><img src="/images/features/flickr1.jpg" align="right" width="100" height="75" style="border:1px solid black;margin-left:10px;" /></p>

<p>SB: There are main things we're setting out to do. The first is
...
<p><img src="/images/features/flickr2.jpg" align="right" width="100" height="75" style="border:1px solid black;margin-left:10px;" /></p>

<p>To fulfill this, we want to get photos into and out of the
...
<p><img src="/images/features/flickr3.jpg" align="right" width="100" height="75" style="border:1px solid black;margin-left:10px;" /></p>

<p>Our second big goal is to enable new ways of organizing photos.
...
of breaking in the digital age.</p>

<p>Part of the solution is to make the process of organizing photos
collaborative. In Flickr, you can give your friends, family, and
other contacts permission to organize your photos &mdash; not just to add
...
<p><strong>CC: How does Flickr use Creative Commons licenses? Do you see Creative Commons licenses
solving problems for Flickr creators and visitors?</strong></p>

<p>SB: We allow members to select a default Creative Commons license for all photos
...
express their preference as to how their work gets used.</p>

<p>This was an important step for us; as individuals and as a
company we believe in and want to support free culture. Creative Commons
licensing is great because it just sort of "snaps in" &mdash; the hard
